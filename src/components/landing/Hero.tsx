      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left pt-8 lg:pt-0 animate-slide-in-left">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-widest mb-8 neumorphic-inset">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-black leading-tight text-foreground mb-8 tracking-tighter">
              Trading <span className="text-muted-foreground">Automático</span> <br />
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
              ...
              <span className="text-foreground italic">100% automatizado</span> y
              seguro.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
              ...
              <button className="w-full sm:w-auto neumorphic-button flex items-center justify-center gap-3 rounded-2xl border border-border bg-secondary px-10 py-5 text-secondary-foreground font-bold text-lg hover:bg-secondary/80 transition-all hover:-translate-y-1 active:scale-95">
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full bg-secondary border-4 border-background flex items-center justify-center text-[10px] font-black text-secondary-foreground neumorphic-outset"
                    >
                      U{i}
                    </div>
                  ))}
                ...
                <div className="flex flex-col">
                  <span className="text-foreground font-black text-base line-height-1">
                    +500
                  </span>
          ...
          <div className="flex-1 w-full max-w-[600px] lg:max-w-none perspective-1000 animate-slide-in-right">
            <div className="relative animate-float duration-[8000ms]">
              {/* Main Card */}
              <div className="neumorphic-outset bg-card backdrop-blur-3xl rounded-[2.5rem] p-8 relative z-20 overflow-hidden border border-border">
                <div className="absolute top-0 right-0 p-8">
                  <div className="bg-primary/20 p-4 rounded-2xl neumorphic-outset">
                ...
                <div className="h-72 w-full neumorphic-inset rounded-3xl relative overflow-hidden mb-8 group">
                  {/* Grid */}
                  <div className="absolute inset-0 opacity-[0.1] dark:opacity-[0.03] bg-[linear-gradient(var(--border)_1px,transparent_1px),linear-gradient(90deg,var(--border)_1px,transparent_1px)] bg-[size:40px_40px]"></div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center justify-between p-4 neumorphic-inset rounded-2xl border border-border">
                    <div className="flex flex-col">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-6 -right-6 neumorphic-outset bg-card p-6 rounded-3xl z-30 animate-float border border-transparent hover:border-border hidden md:block">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black text-foreground">0.05ms</p>
                  </div>
                </div>
              </div>

              <div className="absolute -bottom-8 -left-8 neumorphic-outset bg-card p-6 rounded-3xl z-30 animate-float border border-transparent hover:border-border hidden md:block">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black text-foreground">87.5%</p>
                  </div>
                </div>
              </div>
            </div>
