      ...
      <div className="container mx-auto px-4">
        <div className="neumorphic-outset rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden group">
          ...
          <div className="relative z-10 max-w-4xl mx-auto animate-fade-in-up">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-foreground mb-10 tracking-tighter leading-tight">
              Lleva tu Trading <br />
              <span className="text-muted-foreground italic underline decoration-blue-500 underline-offset-8">
                al Siguiente Nivel
              </span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              ...
              <button
                className="w-full sm:w-auto neumorphic-button px-12 py-6 rounded-[2rem] border border-border text-foreground font-black text-xl hover:bg-secondary transition-all hover:-translate-y-1 active:scale-95"
            ...
            <p className="mt-12 text-muted-foreground font-bold text-sm tracking-wide">
